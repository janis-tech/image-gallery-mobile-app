    ...
    @if($image)
        ...
        <div class="max-w-full">
            ...
            <div class="mt-8 flex justify-end gap-3">
                <a href="{{ route('galleries.image.edit', [$gallery['id'], $image['id']]) }}" class="px-3 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-md flex items-center transition-colors whitespace-nowrap">
                ...
                <button 
                    class="px-3 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 hover:text-red-600 dark:hover:text-red-400 rounded-md flex items-center transition-colors cursor-pointer whitespace-nowrap"
